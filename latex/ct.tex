...
%------------------------------------------------------------
  ...
  \subsubsection{Identity}
    ...
    morphism $id_b$ such that $id_b \circ f = f$ \cite{barr1990category,
      computational}. The identity morphism $id_b$ has no effect on the
...
%------------------------------------------------------------
  ...
  \subsubsection{Composability}
    ...
    are as before and $h: c \rightarrow d$ \cite{awodey2006category,
...
% ------------------------------------------------------------
  ...
  \subsubsection{Product}
    ...
    same but they preserve the same structure. An isomorphism between
    \lstinline|(a, b)| and \lstinline|(b, a)| is commonly defined with a
    ...
    isomorphism and thus it obeys algebraic laws of monoid \cite{barr1990category}.
...
% ------------------------------------------------------------
  ...
  \subsection{Monoid}
    ...
    operation. For example if the binary operator is again a multiplication
    function which operates on integers a unit element is 1.
